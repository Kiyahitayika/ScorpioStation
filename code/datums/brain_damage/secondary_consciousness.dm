...
/datum/brain_trauma/severe/secondary_consciousness
	name = "Secondary Consciousness"
	desc = "Patient's brain has two consciousnesses, which randomly switch control of the body."
	...
	var/mob/living/secondary_consciousness/stranger_backseat //there's two so they can swap without overwriting
	var/mob/living/secondary_consciousness/owner_backseat

/datum/brain_trauma/severe/secondary_consciousness/on_gain()
	..()
	make_backseats()
	get_ghost()

/datum/brain_trauma/severe/secondary_consciousness/proc/make_backseats()
	stranger_backseat = new(owner, src)
	owner_backseat = new(owner, src)

/datum/brain_trauma/severe/secondary_consciousness/proc/get_ghost()
	set waitfor = FALSE
	var/list/mob/dead/observer/candidates = pollCandidatesForMob("Do you want to play as [owner]'s secondary personality?", null, null, null, 75, stranger_backseat)
...
/datum/brain_trauma/severe/secondary_consciousness/on_life()
	if(owner.stat == DEAD)
...
/datum/brain_trauma/severe/secondary_consciousness/on_lose()
...
/datum/brain_trauma/severe/secondary_consciousness/proc/switch_personalities()
	if(QDELETED(owner) || owner.stat == DEAD || QDELETED(stranger_backseat) || QDELETED(owner_backseat))
		return

	var/mob/living/secondary_consciousness/current_backseat
	var/mob/living/secondary_consciousness/free_backseat
	if(current_controller == OWNER)
...
/mob/living/secondary_consciousness
	name = "secondary consciousness"
	real_name = "unknown conscience"
	var/mob/living/carbon/body
	var/datum/brain_trauma/severe/secondary_consciousness/trauma

/mob/living/secondary_consciousness/Initialize(mapload, _trauma)
	if(iscarbon(loc))
		body = loc
		name = body.real_name
...
/mob/living/secondary_consciousness/Life()
	if(QDELETED(body))
...
/mob/living/secondary_consciousness/Login()
	..()
	to_chat(src, "<span class='notice'>As a secondary personality, you cannot do anything but observe. However, you will eventually gain control of your body, switching places with the current personality.</span>")

/mob/living/secondary_consciousness/say(message)
	to_chat(src, "<span class='warning'>You cannot speak, your other self is controlling your body!</span>")
	return FALSE

/mob/living/secondary_consciousness/emote(message)
	return

///////////////BRAINWASHING////////////////////

/datum/brain_trauma/severe/secondary_consciousness/brainwashing
	name = "Secondary Consciousness"
	desc = "Patient's brain has two consciousnesses, which randomly switch control of the body."
	scan_desc = "complete lobe separation"
	gain_text = ""
...
/datum/brain_trauma/severe/secondary_consciousness/brainwashing/New(obj/item/organ/brain/B, _permanent, _codeword, _objective)
	..()
	if(_codeword)
		codeword = _codeword
	else
...
/datum/brain_trauma/severe/secondary_consciousness/brainwashing/on_gain()
	..()
	var/mob/living/secondary_consciousness/traitor/traitor_backseat = stranger_backseat
	traitor_backseat.codeword = codeword
	traitor_backseat.objective = objective

/datum/brain_trauma/severe/secondary_consciousness/brainwashing/make_backseats()
	stranger_backseat = new /mob/living/secondary_consciousness/traitor(owner, src, codeword, objective)
	owner_backseat = new(owner, src)

/datum/brain_trauma/severe/secondary_consciousness/brainwashing/get_ghost()
	set waitfor = FALSE
...
/datum/brain_trauma/severe/secondary_consciousness/brainwashing/on_life()
	return //no random switching

/datum/brain_trauma/severe/secondary_consciousness/brainwashing/on_hear(message, speaker, message_language, raw_message, radio_freq)
	if(owner.disabilities & DEAF || owner == speaker)
		return message
	if(findtext(message, codeword))
		message = replacetext(message, codeword, "<span class='warning'>[codeword]</span>")
		addtimer(CALLBACK(src, /datum/brain_trauma/severe/secondary_consciousness.proc/switch_personalities), 10)
	return message

/datum/brain_trauma/severe/secondary_consciousness/brainwashing/on_say(message)
	if(findtext(message, codeword))
		return "" //oh hey did you want to tell people about the secret word to bring you back?
	return message

/mob/living/secondary_consciousness/traitor
	name = "secondary consciousness"
	real_name = "unknown conscience"
	var/objective
	var/codeword

/mob/living/secondary_consciousness/traitor/Login()
	..()
